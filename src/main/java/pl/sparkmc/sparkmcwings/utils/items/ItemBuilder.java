package pl.sparkmc.sparkmcwings.utils.items;
...
import pl.sparkmc.sparkmcwings.exceptions.ItemMetaNullException;
...
public class ItemBuilder {
    ...
    public ItemBuilder setLeatherArmorColor(Color color){
        try{
            ...
            if (im == null) {
                throw new ItemMetaNullException();
            }
    ...
    /**
     * Sets the Custom Model Data to item.
     * @param data The number of CustomModelData to set.
     */
